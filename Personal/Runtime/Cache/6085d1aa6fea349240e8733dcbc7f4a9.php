	...
	<body>
		<div id="main">
		    ...
		    <div class='head-dark-box'>
					<div class='tit'>内容管理>常用联系人管理</div>
			</div>	
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        <td style="width:400px; height: 25px" align="left" bgcolor="#ffffff">
                                            ...
                                            联系人：<input name="cname" maxlength="20" id="cname" style="width:80px;" type="text">
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                          
                                            联系电话：<input name="telenum" maxlength="40" id="telenum" style="width:100px;" type="text">
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
