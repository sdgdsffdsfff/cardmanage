	...
	<tbody>
		...
		<tr>
			<td colspan="5" >
						...
						<a href="__APP__/Contactmanage/bulkadd">/批量导入联系人</a>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/下载导入文件实例
						<a href="__APP__/Contactmanage/download?id=1">【文本文档】</a>
						<a href="__APP__/Contactmanage/download?id=2">【EXCEL】</a>
		...
		<tr style="background-color:#E5E5E5;font-weight:bold;height:15px;">
		 ...
		 <tr>
                 <td colspan="5" align="center" style="color:red;"></td>
         </tr>
