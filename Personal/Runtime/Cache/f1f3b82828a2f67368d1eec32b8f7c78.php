		...
		<script type="text/javascript">
					...
					function ajaxcardcheck(){
						  ...
						  $.post(
						  	...
						  	{rechargetel:$("#rechargetel").val(),cardnum:$('#num').val(),cardpwd:$('#pwd').val()},
						    function(data){		    
			...
			<table cellpadding="0" cellspacing="1" align="center" bgcolor="#B5C7DE" border="0" width="500px" style="font:12px Verdana, Arial, Helvetica, sans-serif">
		         <tbody>
		            ...
		            <tr>
		                ...
		                <td align="left" bgcolor="#FFFFFF">
		              &nbsp;&nbsp;&nbsp;<input name="num" maxlength="18" id="num"  style="width:133px;" type="text"><span id="cardnummsg" style="color:red;"></span></td>
		            </tr>
		            <tr>
		                <td align="right" bgcolor="#FFFFFF" height="25">
		                    <span style="font-size: 9pt">充值卡密码：</span></td>
		                <td align="left" bgcolor="#FFFFFF">
		               &nbsp;&nbsp;&nbsp;<input name="pwd" maxlength="18" id="pwd"  style="width:133px;" type="password"><span id="cardpwdmsg" style="color:red;"></span></td>
		            </tr>
		            <tr>
