	...
	<body>
		<div id="main">
		             <div class='head-dark-box'>
					   <div class='tit'>用户管理>帐号管理>管理员设置</div>
				     </div>	
						<div class='tip-msg'>
								 提示: 带<span class="red_font">*</span>的项目为必填信息.
						</div>
		    <form  method="post" action="__APP__/Admin/updateAdmin" >
		          
			 <div class="msg-box">
				<ul class="viewmess">
				
					<li class="light-row">
						<span class="col_width">管理员名<span class="red_font">*</span></span>
						<input name="name" type="text"  value="<?php echo ($admin["name"]); ?>" class="text-box">
						可以使用中文，但禁止除[@][.]以外的特殊符号
					</li>
					<li class="dark-row">
					...
					<li class="dark-row">
						...
						<input name="email" type="text"  value="<?php echo ($admin["email"]); ?>" class="text-box">
						请正确添写电子邮件地址
					</li>	
