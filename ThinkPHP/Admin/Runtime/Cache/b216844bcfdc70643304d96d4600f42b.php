	...
	<body>
		<div id="main">
		    <div class='head-dark-box'>
					<div class='tit'>内容管理>信息管理>添加信息</div>
				</div>	
						<div class='tip-msg'>
		    ...
		    <form name="article" method="post" action="__APP__/Article/insert">
			
			
			<div class="msg-box">
				<ul class="viewmess">
					<li class="light-row">
						<span class="col_width">信息分类&nbsp;<span class="red_font">*</span></span>
					...
					<li class="dark-row">
						<span class="col_width">信息标题&nbsp;<span class="red_font">*</span></span>
  						<input type="text" class="text-box" name="title" size="30" maxlength="40">
	
					</li>
					<li class="light-row">
						<span class="col_width">发布时间&nbsp;<span class="red_font">*</span></span>
						<input type="text" class="text-box" name="postTime" size="30" value="<?php echo (date('Y-m-d H:i:s',$postTime)); ?>">&nbsp;&nbsp;如自己更改请注意格式.
					</li>
                    ...
                    <li class="light-row">
						...
						<input type="text" class="text-box" name="comeFrom" size="25"  maxlength="20">
					</li>
