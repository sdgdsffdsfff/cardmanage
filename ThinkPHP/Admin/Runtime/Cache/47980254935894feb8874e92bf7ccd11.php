...
<html>
<head>
<title>后台管理员登陆管理</title>
	<meta name="Author" content="小卢">
	<meta http-equiv="Content-Type" content="text/html;charset=utf8">
    <link rel="stylesheet" href="__ROOT__/Admin/Tpl/resource/css/style.css" type="text/css">
</head>
		...
		<ul>	
			...
			<li class="dark-row">
 			...
 			<li class="light-row">
				...
				<input class="button" value="登录系统" type="submit" name="sub">
