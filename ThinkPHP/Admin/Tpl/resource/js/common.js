//Êó±ê·ÅÈëºÍÀë¿ªÊ±¸Ä±äÍ¼ÏñÏÔÊ¾
function cimg(obj, imgname) {
	obj.src=imgname;
}

//µã»÷Ñ¡Ïî¹ÜÀíÖÐµÄ²Ëµ¥£¬¸Ä±ä²Ëµ¥ÁÐ±íµÄÏÔÊ¾
function switchmenu(menutitle, menulist, num){	
	...
	switch(num){
		case 0: mTitleObj.innerText="ã€ç³»ç»Ÿç®¡ç†ã€‘"; break;
		case 1: mTitleObj.innerText="ã€å†…å®¹ç®¡ç†ã€‘"; break;
		case 2: mTitleObj.innerText="ã€ç”¨æˆ·ç®¡ç†ã€‘"; break;
	}
...
//¶àÑ¡¿ò´¦Àí£¬È«Ñ¡¡¢·´Ñ¡¡¢È«²»Ñ¡
	...
	//»ñÈ¡AJAXÒýÇæµÄXMLHttpRequest¶ÔÏó
	function getXmlhttp() {
		var http_request;
