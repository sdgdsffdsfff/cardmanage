<?php if (!defined('THINK_PATH')) exit();?><html>
			...
			<table  id="addacctable"  style="width:60%;font: 12px Verdana,Arial,Helvetica,sans-serif;" cellspacing="1" align="center" bgcolor="#cccccc">
				...
				<tbody>
					...
					<tr>
						...
						&nbsp;<input name="loginname" maxlength="20" id="loginname" style="width:100px;" type="text">（不能全为数字）</td>
 ...
 if ($_SESSION['authority']['up_bindtel']==1) { echo '<span style="display:inline-block;width:120px;">
				...
				<tr>
					...
					<td colspan="3" bgcolor="#ffffff">	
								<textarea name="remark"  style="width: 200px; height:50px;" >
				...
				<tr>
					...
					<input name="Button1" value="添加" id="Button1" style="width:60px;" type="submit">&nbsp;				
					</td>
				</tr>
				</tbody>
			</table>
