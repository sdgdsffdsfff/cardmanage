...
<div class="head-dark-box">
					<div class="tit">内容管理&gt;开户黑名单管理</div>
														<?php
	...
	<tbody>
		...
		<tr>
			<td colspan="5" >
						...
						<a href="__APP__/Opencard/add">添加开户黑名单</a> 		
						<a href="__APP__/Opencard/bulkadd">/批量导入开户黑名单</a>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/
						导出开户黑名单
						<a href="__APP__/Opencard/download?id=1">【文本文档】</a>
						<a href="__APP__/Opencard/download?id=2">【EXCEL】</a>
				
			</td>	
		</tr>
				<tr>
				<td colspan="5" >号码：<input type="text" name="num" value=""/> 起始时间：<input type="text" name="starttime" id="starttime" class="ui_timepicker" value="<?php echo $firstday;?>"> 截止时间：<input type="text" name="endtime" id="endtime" class="ui_timepicker" value="<?php echo $nowtime?>"> <input type="submit" name="send" value="搜索"/></td></tr>
		<tr style="background-color:#E5E5E5;font-weight:bold;height:15px;">
						<th scope="col" style="width:20%;" align="center">全选<input type="checkbox" name="checkall" value="all"/></th>
...
<td><input type="checkbox" name="check[]" class="check" value="'.$pervalue['id'].'"/></td>
		 ...
		 <tr>
                 <td>操作:<a href="javascript:void(0)" id="del" style="color:#f60">批量删除</a></td><td colspan="4" align="center" style=""><?php echo ($page); ?></td>
         </tr>
