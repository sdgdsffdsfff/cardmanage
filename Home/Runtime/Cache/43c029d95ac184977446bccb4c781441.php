		...
		<script>
					...
					function checkfield(){
						...
						function ajaxadd(){
						  ...
						  $.post("__APP__/Calltransfernum/addcalltransfernum",
						  	{calltransfernum:$('#calltransfernum').val()},
						  function(data){
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        <td style="width:400px; height: 25px" align="left" bgcolor="#ffffff">
 											 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 	 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                            呼转号码：
                                            <input name="calltransfernum" maxlength="20" style="width:120px;" type="text" id="calltransfernum">
                                        ...
                                        <td style="height: 25px" align="left" bgcolor="#ffffff">
                                            ...
                                            <input name="back" value="返回" id="back" onclick="window.location.href='__APP__/Calltransfernum/index'" type="button">
