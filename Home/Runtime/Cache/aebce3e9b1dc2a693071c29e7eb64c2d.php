		...
		<script>
					...
					function checkfield(){
						...
						function ajaxadd(){
						  ...
						  $.post("__APP__/Contactmanage/addcontact",
...
<!--action="__APP__/Transfercard/transfer"-->
          ...
          <form method="post" action="__APP__/Calltransfernum/upfile" enctype="multipart/form-data">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 25px" align="left" bgcolor="#ffffff">
                                           ...
                                           <input type='submit'value='导入呼转号码' id='submitbutton'/>
