                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        <td style="width:700px; height: 25px" align="left" bgcolor="#ffffff">
                                            ...
                                            起始时刻：<input name="starttime" maxlength="20" id="starttime" style="width:80px;" type="text" value="<?php  echo $ratedata[0]['starttime'];?>">
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                          
                                            结束时刻：<input name="stoptime" maxlength="20" id="stoptime" style="width:80px;" type="text" value="<?php  echo $ratedata[0]['endtime']?>">
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                             费率<input name="rate" maxlength="20" id="rate" style="width:80px;" type="text"  value="<?php echo $ratedata[0]['fee'];?>">元
                                             &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                             备注：<input name="remark" id="remark" style="width:80px;" type="text" value="<?php echo $ratedata[0]['remark']?>">
	                                        ...
	                                        <td style="height: 25px"  bgcolor="#ffffff" align="left">
	                                            ...
	                                            <input name="submit" value="修改费率" id="submit" style="height:22px;" onclick="return checkfield()" type="submit">
	                                            <input name="Button2" value="返回" id="Button2" onclick="window.location.href='__APP__/Ratemanage/qubyacc?id=<?php echo $ratedata[0]['ownid'];?>'" style="width:60px;" type="button">
