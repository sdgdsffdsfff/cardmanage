   ...
   <body>
		<div id="main">
		    ...
		    <div class='head-dark-box'>
					<div class='tit'>内容管理>账号查询>账号信息</div>
			</div>	
...
<table rules="all" id="MyGridView" style="border-color:Black;border-width:1px;border-style:solid;font-size:10pt;height:10px;width:90%;border-collapse:collapse;" cellpadding="3" cellspacing="0" align="Center" border="1">
 ...
 if (!empty($userdata)) { foreach ($userdata as $key => $cardvalue) { echo '<tr style="height:25px;" align="center"><td align="center" width="100px">'.$cardvalue['phonenum'].'</td>
								<td style="width:60px;" align="center">'.$cardvalue['banlance'].'</td>
								...
								<td style="width:200px;"  align="center">
							    	...
							    	/<a href="__APP__/Queryphone/donate?userid='.$cardvalue['id'].'&phonenum='.$cardvalue['phonenum'].'">赠送查询</a>
								</td>	
								<td scope="col">'.($cardvalue['state']==1?'未禁用':'<span style="color:red">已禁用</span>').'</td>			
								<td><a href="__APP__/Queryphone/updatephone?id='.$cardvalue['id'].'">修改</a></td></tr>'; } }else { echo '<tr> <td colspan="8" align="center" style="color:red;"> 没有符合您要找的账号卡信息</td></tr>'; } ?>
