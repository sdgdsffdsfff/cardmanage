<?php if (!defined('THINK_PATH')) exit();?><html>
		...
		<script>
					...
					function checkfield(){
						...
						function ajaxadd(){
						  ...
						  $.post("__APP__/Blackcallednum/addblack",
	...
	<body>
       ...
       <!--action="__APP__/Transfercard/transfer"-->
          ...
          <form method="post" action="__APP__/Blackcallednum/upfile" enctype="multipart/form-data">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 25px" align="left" bgcolor="#ffffff">
                                           ...
                                           <input type='submit'value='导入黑名单' id='submitbutton'/>
