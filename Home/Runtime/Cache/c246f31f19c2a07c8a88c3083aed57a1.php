	...
	<tbody>
		<tr>
			<td colspan="5" >
				...
				<tr><td colspan="5" >号码：<input type="text" name="num" value=""/> 起始时间：<input type="text" name="starttime" id="starttime" class="ui_timepicker" value="<?php echo $firstday;?>"> 截止时间：<input type="text" name="endtime" id="endtime" class="ui_timepicker" value="<?php echo $nowtime?>"> <input type="submit" name="send" value="搜索"/></td></tr>
		<tr style="background-color:#E5E5E5;font-weight:bold;height:15px;">
			...
			<th scope="col" style="width:20%;" align="center">编号</th>
			<th scope="col">号码</th>
			<th scope="col">添加时间</th>
			<th scope="col">操作</th>
		</tr>

		   <?php  $key=1; foreach ($transfernumdata as $pervalue) { echo '<tr id="tr'.$pervalue['num'].'">
								<td><input type="checkbox" name="check[]" class="check" value="'.$pervalue['num'].'"/></td>
