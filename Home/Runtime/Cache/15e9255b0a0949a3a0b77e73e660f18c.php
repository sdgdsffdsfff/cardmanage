...
<table rules="all" id="MyGridView" style="border-color:Black;border-width:1px;border-style:solid;font-size:10pt;height:10px;width:50%;border-collapse:collapse;" cellpadding="3" cellspacing="0" align="Center" border="1">
	<tbody>
		...
		<tr><td  align="center" colspan="3"><?php echo ($page); ?></td></tr>
   
                 <?php  echo '<tr><td colspan="3" align="center" style="color:red;">'; foreach ($addresult as $key => $value) { echo $value.'<br/>'; } foreach ($checkresult as $key => $value) { echo $value.'<br>'; } echo '</tr></td>'; ?>
